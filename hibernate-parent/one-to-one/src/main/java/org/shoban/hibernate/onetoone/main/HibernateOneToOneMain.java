...
import org.shoban.hibernate.onetoone.model.Customer;
import org.shoban.hibernate.onetoone.model.Txn;
import org.shoban.hibernate.onetoone.util.HibernateUtil;
...
public class HibernateOneToOneMain {
	...
	private static Txn buildDemoTransaction() {
		...
		cust.setEmail("Shoban@gmail.com");
		cust.setName("Shoban Kumar");
