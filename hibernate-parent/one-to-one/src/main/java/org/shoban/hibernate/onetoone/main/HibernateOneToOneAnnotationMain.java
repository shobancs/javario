package org.shoban.hibernate.onetoone.main;
...
import org.shoban.hibernate.onetoone.model.Customer1;
import org.shoban.hibernate.onetoone.model.Txn1;
import org.shoban.hibernate.onetoone.util.HibernateAnnotationUtil;
...
public class HibernateOneToOneAnnotationMain {
	...
	private static Txn1 buildDemoTransaction() {
		...
		cust.setEmail("Shoban@yahoo.com");
		cust.setName("Shoban Kr");
